import { ShieldAlert, MapPinOff, WifiOff } from 'lucide-react'
...
const PRESETS = {
  denied: {
    ...
    desc: 'StormScope needs your location to center the radar around you. Enable location for this site in your browser settings, then try again.',
    cta: 'Try again',
    accent: '#f43f5e',
  },
  unsupported: {
